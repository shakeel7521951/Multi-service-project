   ...
   const features = [
      {
         ...
         icon: <FiPlus className="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:h-8" />,
         gradient: "from-cyan-500 to-blue-600",
      },
      {
         title: "Time Management",
         desc: "Learn how to plan your study hours and stay consistent every day.",
         icon: <FiClock className="w-6 h-6 xs:w-7 xs:h-7 sm:w-8 sm:h-8" />,
            ...
            >
               <div>
                  ...
                  <p className="text-slate-300 text-sm xs:text-base sm:text-lg md:text-xl leading-relaxed text-center lg:text-left">
                     ...
                     efficiently. Whether it's time management, structured
                     notes, or staying focused, we provide what you need to
                     succeed.
                  </p>
               </div>
