    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 px-4 py-10">
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <div className="flex justify-between">
          <button className="flex items-center gap-2 bg-[#04AA6D] text-white font-semibold px-5 py-2 rounded-xl shadow hover:scale-105 hover:bg-[#03945f] transition">
            <FaChevronLeft />
            Home
          </button>
        </div>
        ...
        <section className="bg-[#FFF4A3] p-8 rounded-2xl shadow-md">
          ...
          <button className="bg-[#FFC0C7] hover:bg-[#ffa8b1] text-black font-semibold px-6 py-2 rounded-xl shadow transition">
            Start Learning Now »
          </button>
        </section>
        ...
        <section className="space-y-8">
          ...
          {[
              ...
              content: (
                <>
                  <div className="mb-4">
                    ...
                    <pre className="bg-gray-100 p-3 rounded-lg shadow-inner overflow-x-auto">10.50{"\n"}1001</pre>
                  </div>
                  <div>
                    <h3 className="font-semibold mb-2">2. Strings:</h3>
                    <pre className="bg-gray-100 p-3 rounded-lg shadow-inner overflow-x-auto">"John Doe"{"\n"}'John Doe'</pre>
                  </div>
                </>
              ),
            },
            {
              ...
              content: (
                <>
                  ...
                  <pre className="bg-gray-100 p-3 rounded-lg shadow-inner overflow-x-auto">let x;{"\n"}x = 6;</pre>
                </>
              ),
            },
            {
              ...
              content: (
                <>
                  ...
                  <pre className="bg-gray-100 p-3 rounded-lg shadow-inner mb-4 overflow-x-auto">(5 + 6) * 10</pre>
                  <p className="mb-2">Assignment operator:</p>
                  <pre className="bg-gray-100 p-3 rounded-lg shadow-inner overflow-x-auto">let x, y;{"\n"}x = 5;{"\n"}y = 6;</pre>
                </>
              ),
            },
            {
              ...
              content: (
                <>
                  ...
                  <pre className="bg-gray-100 p-3 rounded-lg shadow-inner mb-2 overflow-x-auto">5 * 10</pre>
                  <pre className="bg-gray-100 p-3 rounded-lg shadow-inner overflow-x-auto">"John" + " " + "Doe"  // Evaluates to "John Doe"</pre>
                </>
              ),
            },
            {
            ...
            },
            {
              ...
              content: (
                <pre className="bg-gray-100 p-3 rounded-lg shadow-inner overflow-x-auto">let x = 5;   // This will execute{"\n\n"}// let x = 6; This won't execute{"\n\n"}/*{"\n"}Multi-line{"\n"}comment{"\n"}*/</pre>
              ),
            },
            {
              ...
              content: (
                <>
                  ...
                  <pre className="bg-gray-100 p-3 rounded-lg shadow-inner overflow-x-auto">let lastname, lastName;  // Different variables{"\n"}lastName = "Doe";{"\n"}lastname = "Peterson";</pre>
                </>
              ),
            },
            {
            ...
            <div key={idx} className="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition">
              <h2 className="text-2xl font-bold mb-4 text-[#04AA6D]">{section.title}</h2>
              {section.content}
            </div>
          ))}
        </section>
        ...
        <section className="bg-gray-50 p-6 rounded-2xl shadow">
          <h2 className="text-2xl font-semibold mb-2">Practice Live with JavaScript</h2>
          <p className="text-gray-700 mb-4">
            Try out JavaScript code directly in your browser and see the results instantly.
          </p>
          <div className="bg-[#E7E9EB] p-6 rounded-xl">
            <h3 className="font-bold mb-3">Example:</h3>
            <pre className="bg-white border-l-4 border-[#04AA6D] p-4 font-mono text-sm rounded overflow-x-auto shadow-inner">
              <code>{jsExample}</code>
            </pre>
            <button
              onClick={handleCopy}
              className="bg-[#04AA6D] hover:bg-[#03945f] text-white font-semibold mt-4 px-6 py-2 rounded-xl shadow transition"
            >
        ...
        <section>
          <h2 className="text-3xl font-bold mb-4 text-gray-800">JavaScript References</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {references.map((ref, idx) => (
              <button
                key={idx}
                className="cursor-pointer bg-white shadow rounded-xl text-gray-800 text-center font-medium py-3 px-4 hover:bg-black hover:text-white transition"
              >
                {ref}
              </button>
            ))}
