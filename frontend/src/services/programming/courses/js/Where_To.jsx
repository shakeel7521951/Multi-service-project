...
<script src="myScript.js"></script>`,
  ...
  const renderCodeBlock = (title, code) => (
    <div className="bg-[#E7E9EB] p-6 rounded-xl shadow space-y-3">
      ...
      <pre className="bg-white border-l-4 border-[#04AA6D] p-4 font-mono text-sm sm:text-base rounded whitespace-pre-wrap break-words overflow-x-auto">
        <code>{code}</code>
      </pre>
      <button
    ...
    <div className="bg-white px-4 py-10">
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <header className="text-start space-y-2">
          <h1 className="text-3xl font-extrabold">JavaScript Basics</h1>
        ...
        <section className="bg-[#D9EEE1] p-8 rounded-lg shadow space-y-4">
          <h2 className="text-2xl font-bold">The &lt;script&gt; Tag</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-2xl font-semibold">JavaScript Functions and Events</h2>
        ...
        <section className="space-y-10">
          <div className="space-y-3">
            <h2 className="text-2xl font-semibold">JavaScript in &lt;head&gt;</h2>
            <p className="text-gray-700">
          ...
          <div className="space-y-3">
            <h2 className="text-2xl font-semibold">JavaScript in &lt;body&gt;</h2>
            <p className="text-gray-700">
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-700">
              You can reference external scripts using a full URL, a relative
