...
const Js_Versions = () => {
  const versions = [
    {
      version: "ES1",
      name: "ECMAScript 1 (1997)",
      description: "First edition"
    },
    {
      version: "ES2",
      name: "ECMAScript 2 (1998)",
      description: "Editorial changes"
    },
    {
      version: "ES3",
      name: "ECMAScript 3 (1999)",
      description: "Added regular expressions, try/catch, switch, do-while"
    },
    {
      version: "ES4",
      name: "ECMAScript 4",
    ...
    {
      version: "ES5",
      name: "ECMAScript 5 (2009)",
      description: "Added 'strict mode', JSON support, String.trim(), Array.isArray(), Array iteration methods, Allows trailing commas for object literals"
    },
    {
      version: "ES6",
      name: "ECMAScript 2015",
      description: "Added let and const, default parameter values, Array.find(), Array.findIndex()"
    },
    {
      version: "ES7",
      name: "ECMAScript 2016",
      description: "Added exponential operator (**), Array.includes()"
    },
    {
      version: "ES8",
      name: "ECMAScript 2017",
      description: "Added string padding, Object.entries(), Object.values(), async functions, shared memory, Allows trailing commas for function parameters"
    },
    {
      version: "ES9",
      name: "ECMAScript 2018",
      description: "Added rest/spread properties, asynchronous iteration, Promise.finally(), Additions to RegExp"
    },
    {
      version: "ES10",
      name: "ECMAScript 2019",
      description: "Added String.trimStart(), String.trimEnd(), Array.flat(), Object.fromEntries, Optional catch binding"
    },
    {
      version: "ES11",
      name: "ECMAScript 2020",
      description: "Added The Nullish Coalescing Operator (??)"
    }
  ];
    ...
    <div className="min-h-screen bg-white px-4 py-10">
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <div className="text-start">
          <h1 className="text-3xl font-extrabold mb-2">JavaScript Versions</h1>
              ...
              <tbody>
                {versions.map((ver, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4 border-b">{ver.description}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section>
          ...
          <p className="text-gray-700 mb-4">
            Try out modern JavaScript features in your browser.
          </p>
          <div className="bg-[#E7E9EB] p-6 rounded-xl">
            <h3 className="font-bold mb-3">ES6+ Example:</h3>
                ...
                <tbody>
                  {browserSupportES5.map((browser, index) => (
                    <tr key={index} className="hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4 border-b">{browser.note || '-'}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
