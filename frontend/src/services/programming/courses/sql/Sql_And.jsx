    ...
    <div className="min-h-screen bg-white px-4 py-10">
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <header className="text-start">
          <h1 className="text-3xl font-extrabold mb-2">SQL AND Operator</h1>
          <p className="text-gray-600 text-lg">
            The <strong>AND</strong> operator is used in the <strong>WHERE</strong> clause to filter records based on more than one condition.
          </p>
        </header>
        ...
        <section className="bg-[#D9EEE1] p-8 rounded-lg shadow">
          <h2 className="text-2xl font-bold mb-4">Example: Customers from Spain starting with 'G'</h2>
        ...
        <section>
          ...
          <p className="text-gray-700 mt-3">
            The <strong>AND</strong> operator returns a record only if <strong>all conditions</strong> are TRUE.
          </p>
        </section>

        {/* AND vs OR */}
        <section className="bg-[#FFF4CC] p-6 rounded-lg shadow">
          <h2 className="text-2xl font-bold mb-3">AND vs OR</h2>
        ...
        <section className="bg-[#D9EEE1] p-8 rounded-lg shadow">
          <h2 className="text-2xl font-bold mb-4">All Conditions Must Be True</h2>
          <pre className="bg-white border-l-4 border-[#04AA6D] p-4 font-mono text-sm rounded overflow-x-auto mb-4">
            <code>{sqlEx2}</code>
          </pre>
          <button
        ...
        <section className="bg-[#E7E9EB] p-6 rounded-lg shadow">
          ...
          <p className="mb-4 text-gray-700">
            True or False: The AND operator is used to filter records based on more than one condition.
          </p>
          <ul className="space-y-2 text-gray-800">
            <li className="font-bold">True ✅</li>
            <li>False</li>
          </ul>
        </section>
