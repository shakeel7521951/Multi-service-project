...
const Sql_Update = () => {
  ...
  const sqlSyntax = `UPDATE table_name\nSET column1 = value1, column2 = value2, ...\nWHERE condition;`;

  const sqlEx1 = `UPDATE Customers\nSET ContactName = 'Alfred Schmidt', City= 'Frankfurt'\nWHERE CustomerID = 1;`;

  const sqlEx2 = `UPDATE Customers\nSET ContactName='Juan'\nWHERE Country='Mexico';`;

  const sqlEx3 = `UPDATE Customers\nSET ContactName='Juan';`;
  ...
  return (
    <div className="min-h-screen bg-white px-4 py-10">
      <div className="max-w-5xl mx-auto space-y-12">
        {/* Header */}
        <header>
          <h1 className="text-3xl font-extrabold mb-2">SQL UPDATE Statement</h1>
        ...
        {/* Syntax */}
        <section>
          <h2 className="text-2xl font-bold mb-4">UPDATE Syntax</h2>
          <pre className="bg-gray-100 p-4 rounded text-sm overflow-x-auto">
            <code>{sqlSyntax}</code>
          </pre>
          <p className="text-gray-700 mt-3">
            <strong>Note:</strong> Be careful when updating records in a table! If you omit the <strong>WHERE</strong> clause, all records in the table will be updated!
          </p>
        </section>
        ...
        <section className="bg-[#D9EEE1] p-8 rounded-lg shadow">
          <h2 className="text-2xl font-bold mb-4">Example: Update a Single Record</h2>
        ...
        {/* Example 2 */}
        <section className="bg-[#D9EEE1] p-8 rounded-lg shadow">
          <h2 className="text-2xl font-bold mb-4">Example: Update Multiple Records</h2>
          <pre className="bg-white border-l-4 border-[#04AA6D] p-4 font-mono text-sm rounded overflow-x-auto mb-4">
            <code>{sqlEx2}</code>
          </pre>
          <button
        ...
        <section className="bg-[#FFF3CD] p-8 rounded-lg shadow border border-yellow-300">
          <h2 className="text-2xl font-bold mb-4 text-red-700">⚠️ Update Warning!</h2>
          <p className="mb-4 text-gray-700">
            Be careful when updating records. If you omit the <strong>WHERE</strong> clause, <strong>ALL</strong> records will be updated!
          </p>
        ...
        <section className="bg-[#E7E9EB] p-6 rounded-lg shadow">
          ...
          <p className="mb-4 text-gray-700">What is the purpose of the SQL UPDATE statement?</p>
          <ul className="space-y-2 text-gray-800">
            <li>To add new records to a table</li>
            <li>To delete records from a table</li>
            <li className="font-bold">To modify existing records in a table ✅</li>
