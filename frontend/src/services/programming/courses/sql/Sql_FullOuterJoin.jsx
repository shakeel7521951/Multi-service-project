...
const Sql_FullOuterJoin = () => {
  const [copied, setCopied] = useState("");

  const sqlEx1 = `SELECT Customers.CustomerName, Orders.OrderID\nFROM Customers\nFULL OUTER JOIN Orders ON Customers.CustomerID=Orders.CustomerID\nORDER BY Customers.CustomerName;`;
  ...
  return (
    <div className="min-h-screen bg-white px-4 py-10 mt-20">
      <div className="max-w-5xl mx-auto space-y-12">
        {/* Header */}
        <header>
          <h1 className="text-3xl font-extrabold mb-2">SQL FULL OUTER JOIN Keyword</h1>
          <p className="text-gray-600 text-lg">
            The <strong>FULL OUTER JOIN</strong> keyword returns all records when there is a match in left (<strong>table1</strong>) or right (<strong>table2</strong>) table records.
          </p>
        ...
        {/* Syntax */}
        <section>
          <h2 className="text-2xl font-bold mb-4">FULL OUTER JOIN Syntax</h2>
        ...
        <section>
          ...
          <p className="text-gray-700 mb-4">
            In this tutorial we will use the well-known <strong>Northwind</strong> sample database.
          </p>
        ...
        <section className="bg-[#D9EEE1] p-8 rounded-lg shadow">
          <h2 className="text-2xl font-bold mb-4">SQL FULL OUTER JOIN Example</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-xl font-semibold mt-6 mb-2">Result Set (Sample)</h3>
          <div className="overflow-x-auto">
            <table className="w-full border border-gray-300 text-sm text-left">
              <thead className="bg-gray-100">
                <tr>
              ...
              <tbody>
                <tr>
                  <td className="border px-3 py-2">Null</td>
                  <td className="border px-3 py-2">10309</td>
                </tr>
                <tr>
                  <td className="border px-3 py-2">Null</td>
        ...
        <section className="bg-[#E7E9EB] p-6 rounded-lg shadow">
          ...
          <p className="mb-4 text-gray-700">
            Which JOIN keyword returns all records from both tables, even if there is no match?
          </p>
          <ul className="space-y-2 text-gray-800">
            <li>INNER JOIN</li>
            <li>LEFT JOIN</li>
            <li>RIGHT JOIN</li>
            <li className="font-bold">FULL OUTER JOIN ✅</li>
          </ul>
        </section>
...
export default Sql_FullOuterJoin;
