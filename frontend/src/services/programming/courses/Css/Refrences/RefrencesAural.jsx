    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Aural Reference</h1>
      ...
      <div className="px-5  mt-5 py-10 rounded-md">
        <h1 className="text-2xl mb-5">Aural Style Sheets</h1>
        <p>
          Aural style sheets use a combination of speech synthesis and sound
          effects to make the user listen to information, instead of reading
          information.
        </p>

        <h2 className="my-5">Aural presentation can be used:</h2>
        <ul className="flex list-disc px-5 flex-col gap-3 my-5">
          <li>by blind people</li>
          <li className="">to help users learning to read</li>
      ...
      <div className="px-3 py-5 rounded-md">
        <h1 className="text-2xl">An example of an Aural style sheet:</h1>
        <pre className="bg-white text-black font-mono text-sm whitespace-pre-wrap px-6 py-5 mt-3 rounded-md">
          {cssCode}
        </pre>
        <p className="my-5">
          The example above will make the speech synthesizer play a sound, then
          speak the headers in a very rich male voice.
        </p>
