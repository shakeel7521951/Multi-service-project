    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Web Safe Fonts</h1>
      ...
      <div className="px-5 mt-5 py-10 rounded-md">
        <h1 className="text-2xl mb-3">Best Web Safe Fonts for HTML and CSS</h1>
        <p className="pb-3">
          The following fonts are the best web safe fonts for HTML and CSS:
        </p>
        <ul className="flex flex-col gap-3 my-5">
          <li>
            Arial (<code>sans-serif</code>)
          </li>
          <li>
            Verdana (<code>sans-serif</code>)
          </li>
          <li>
            Tahoma (<code>sans-serif</code>)
          </li>
          <li>
            Trebuchet MS (<code>sans-serif</code>)
          </li>
          <li>
            Times New Roman (<code>serif</code>)
          </li>
          <li>
            Georgia (<code>serif</code>)
          </li>
          <li>
            Garamond (<code>serif</code>)
          </li>
          <li>
            Courier New (<code>monospace</code>)
          </li>
          <li>
            Brush Script MT (<code>cursive</code>)
          </li>
        </ul>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">Arial (sans-serif)</h1>
        <p>
