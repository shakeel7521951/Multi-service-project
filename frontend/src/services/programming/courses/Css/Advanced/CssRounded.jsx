    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Rounded Corners</h1>
      ...
      <div className="px-5  border-2 border-red-500 rounded-4xl mt-5 py-10 ">
        <h1 className="text-2xl">CSS Rounded Corners</h1>
