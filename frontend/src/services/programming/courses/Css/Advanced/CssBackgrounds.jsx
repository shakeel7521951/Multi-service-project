    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Multiple Backgrounds</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <h1 className="text-2xl">CSS Multiple Backgrounds</h1>
        <ul className="flex flex-col gap-3 my-5">
          ...
          <li>
            The following example has two background images, the first image is
            a flower (aligned to the bottom and right) and the second image is a
            paper background (aligned to the top-left corner):
          </li>
        </ul>
