    ...
    <div className="px-4">
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Box Sizing</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        ...
        <p className="pb-3">
          <strong>Without the CSS box-sizing Property</strong><br/>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">Box Sizing Example</h1>
        <p>Here are two &lt;div&gt; elements with the same specified width and height, but one includes padding which affects its size:</p>
      </div>
