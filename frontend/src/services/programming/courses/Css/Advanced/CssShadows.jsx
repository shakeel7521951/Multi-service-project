    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Shadow Effects</h1>
      ...
      <div className="px-5 mt-5 py-10 rounded-md">
        <p className="pb-3">With CSS you can create shadow effects!</p>
        <h1 className="text-2xl font-bold mb-2">CSS Shadow Effects</h1>
        <p className="pb-2">
          With CSS you can add shadow to text and to elements.
        </p>
        
        <p className="pt-4">In these chapters you will learn about the following properties:</p>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">CSS Text Shadow Example</h1>
        <p>
          The CSS <code>text-shadow</code> property applies shadow to text.
        </p>
        <p>
