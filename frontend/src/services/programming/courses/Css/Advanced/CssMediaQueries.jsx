    ...
    <div className="px-4">
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Media Queries</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <p className="pb-3">
          The <code>@media</code> rule, introduced in CSS2, made it possible to define different style rules for different media types.
        </p>
        <p className="pb-3">
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">Media Query Example</h1>
        <p>The following example changes the background color based on viewport size and orientation:</p>
      </div>
