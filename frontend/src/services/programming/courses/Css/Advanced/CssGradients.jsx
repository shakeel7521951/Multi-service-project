    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Gradients</h1>
      ...
      <div className="px-5 mt-5 py-10 rounded-md">
        ...
        <h1 className="text-2xl">Gradient Types</h1>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">CSS Gradient Example</h1>
        <p>
          This example uses a linear gradient from left to right, starting fully transparent and transitioning to solid red:
        </p>
      </div>
