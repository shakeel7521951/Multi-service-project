    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Animations</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        ...
        <p className="pb-4">
          An animation lets an element gradually change from one style to another. You can change as many CSS properties as you want, as many times as you want.
        </p>
        <p className="pb-4">
          To use CSS animation, you must first define some keyframes that describe the styles at different stages of the animation.
        </p>
        ...
        <ul className="list-disc list-inside space-y-2 pl-2">
          ...
          <li><code>animation</code> (shorthand)</li>
        </ul>

        <h2 className="text-xl font-semibold mt-6 mb-2">
          The <code>@keyframes</code> Rule
        </h2>
        <p className="pb-4">
          When you specify CSS styles inside the <code>@keyframes</code> rule, the animation will gradually change from the current style to the new style at specified points in time.
        </p>
        <p className="pb-4">
          To apply an animation, bind it to an element using <code>animation-name</code> and <code>animation-duration</code>.
        </p>
...
div {
  ...
  animation-duration: 4s;
        ...
        {/* Define the keyframes for live example */}
        <style>
          {`@keyframes example {
            from { background-color: red; }
            to { background-color: yellow; }
