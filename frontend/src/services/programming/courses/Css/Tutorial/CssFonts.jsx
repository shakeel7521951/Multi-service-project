    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Fonts</h1>
      ...
      <div className="px-5  mt-5 py-10 rounded-md">
        ...
        <h1 className="text-2xl">Font Selection is Important</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li>
            Choosing the right font has a huge impact on how the readers
            experience a website.
          </li>
          <li>The right font can create a strong identity for your brand.</li>
          <li>
            Using a font that is easy to read is important. The font adds value
            to your text. It is also important to choose the correct color and
      ...
      <div className="px-3 py-5 bg-[#E7E9EB] rounded-md">
        ...
        <p>Specify some different fonts for three paragraphs:</p>
