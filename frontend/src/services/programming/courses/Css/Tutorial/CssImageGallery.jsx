    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Image Gallery</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <p className="pb-3">
          CSS can be used to create a beautiful and responsive image gallery layout.
        </p>
        <h1 className="text-2xl">What is a CSS Image Gallery?</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li>Images are placed inside a grid using floated divs.</li>
          <li>Each image is styled with borders, spacing, and hover effects.</li>
          <li>Descriptions can be added under each image using separate elements.</li>
        </ul>
        <div className="flex px-5 w-fit cursor-pointer py-2 text-xl font-semibold rounded-lg text-white bg-[#03945F] items-center">
          Try CSS Gallery Example
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">Example of CSS Image Gallery</h1>
        <p>
          Here's a simple example of how you can use CSS to build a basic image gallery layout.
        </p>
      </div>

      <div className="px-3 py-5 bg-[#E7E9EB] rounded-md">
        <h1 className="text-2xl">CSS Image Gallery Example</h1>
