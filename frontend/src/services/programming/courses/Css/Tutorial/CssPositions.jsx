    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Layout - The position Property</h1>
      ...
      <div className="px-5  mt-5 py-10 rounded-md">
        ...
        <h1 className="text-2xl mb-3">The position Property</h1>
        <p className="pb-3 mb-3">
          The <span className="text-red-400">position</span> property specifies
          the type of positioning method used for an element.
        </p>
        <div>
          <p>There are five different position values:</p>
          <ul className="text-red-400  flex flex-col gap-3 px-5 py-3 text-lg">
            <li>static</li>
            <li>relative</li>
            <li>fixed</li>
            <li>absolute</li>
