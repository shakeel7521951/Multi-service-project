    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Layout - float and clear</h1>
      ...
      <div className="px-5  mt-5 py-10 rounded-md">
        <p className="mb-10">
          The CSS <span className="text-red-400">float</span> property specifies
          how an element should float.
        </p>
        <p className="mb-10">
          The CSS <span className="text-red-400">clear</span> property specifies
          what elements can float beside the cleared element and on which side.
        </p>
        <div className="flex justify-between mb-10">
          <div className="px-10 py-3 bg-blue-500 text-white text-lg font-semibold">
            Float Left
          </div>
          <div className="px-10 py-3 bg-red-500 text-white text-lg font-semibold">
            Float Right
          </div>
        </div>
