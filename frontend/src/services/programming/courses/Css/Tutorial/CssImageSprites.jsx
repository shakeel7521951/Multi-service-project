    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Image Sprites</h1>
      ...
      <div className="px-5 mt-5 py-10 rounded-md">
        <p className="pb-3">
          CSS Image Sprites are used to optimize web performance by combining multiple images into a single image file.
        </p>
        <h1 className="text-2xl">What is an Image Sprite?</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li>An image sprite is a collection of images placed into a single image.</li>
          <li>Using image sprites reduces the number of HTTP requests, improving page load time.</li>
          <li>You can show specific parts of the sprite using CSS background positioning.</li>
        </ul>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">CSS Image Sprite Example</h1>
        <p>
          Below is an example of how to show a specific icon from a sprite image using CSS:
        </p>
      </div>
