    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Specificity</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <p className="pb-3">
          ...
          selector with the highest specificity will be applied.
        </p>
        <h1 className="text-2xl font-semibold">What is Specificity?</h1>
        <p className="my-5">
          Think of specificity as a hierarchy that determines which style
          declaration is ultimately applied to an element.
        </p>
        <p>
          For example, a class selector has more specificity than a tag selector.
        </p>
      ...
      <div className="flex flex-col gap-4 mb-6">
        ...
        <p>Here, the paragraph text will be red due to a simple selector rule.</p>
      </div>
