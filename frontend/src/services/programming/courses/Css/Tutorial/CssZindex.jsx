    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Layout - The z-index Property</h1>
      ...
      <div className="px-5  mt-5 py-10 rounded-md">
        <p className="mb-10">
          The <span className="text-red-400 ">z-index</span> property specifies
          the stack order of an element.
        </p>
        <h1 className="text-2xl mb-3">The z-index Property</h1>
        <p className="pb-3 mb-3">
         The <span className="text-red-400 ">z-index</span> property specifies the stack order of an element (which element should be placed in front of, or behind, the others).
        </p>
