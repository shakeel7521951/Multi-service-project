    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Lists</h1>
      ...
      <div className="flex flex-col  sm:flex-row justify-between gap-10 p-10">
        <div>
          <h1 className="text-3xl">Unordered List</h1>
        ...
        <div>
          <h1 className="text-3xl">Ordered List</h1>
      ...
      <div className="my-5">
        <h1 className="text-4xl ">Different List Item Markers</h1>
        <p className="my-3">
