    ...
    <div className="px-4">
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Counters</h1>
      ...
      <div className="px-5 mt-5 py-10 rounded-md">
        <p className="pb-3">
          CSS Counters are variables in CSS that help in automatically numbering elements based on their placement in the document.
        </p>
        <h1 className="text-2xl">Automatic Numbering With Counters</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li><strong>counter-reset</strong> - Creates or resets a counter</li>
          <li><strong>counter-increment</strong> - Increments the counter</li>
          <li><strong>content</strong> - Inserts generated content</li>
          <li><strong>counter()</strong> - Returns the current value of the counter</li>
        </ul>
        <p className="pb-3">
          This allows you to dynamically label sections like headings without manually entering numbers.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">CSS Counter Example</h1>
        <p>This example automatically numbers the &lt;h2&gt; elements using CSS counters.</p>
      </div>
