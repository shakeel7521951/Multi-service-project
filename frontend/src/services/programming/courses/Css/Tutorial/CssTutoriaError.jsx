    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Errors</h1>
      ...
      <div className="px-5 mt-5 py-10 rounded-md">
        <h1 className="text-2xl">CSS Errors</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li>
            Errors in CSS can lead to unexpected behavior or styles not being
            applied correctly. This page shows common CSS mistakes and how to
            avoid them.
          </li>

          <h1 className="mt-5 text-2xl ">Missing Semicolons</h1>
          <li>
            Forgetting a semicolon at the end of a property declaration can
...
export default CssTutoriaError;
