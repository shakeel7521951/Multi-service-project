    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Icons</h1>
      ...
      <div className="px-5 mt-5 py-10 rounded-md">
        ...
        <div>
          <h1 className="text-2xl">How To Add Icons</h1>
          <ul className="flex flex-col gap-3 my-5">
            ...
            <li>
              All the icons in the icon libraries below, are scalable vectors
              that can be customized with CSS (size, color, shadow, etc.)
            </li>
          </ul>
        </div>
        <div>
          <h1 className="text-2xl">Font Awesome Icons</h1>
          <ul className="flex flex-col gap-3 my-5">
            <li>
