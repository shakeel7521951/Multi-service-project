    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Links</h1>
      ...
      <div className="border text-xl items-center flex gap-10 p-5">
        <div className="underline">Text Link</div>
        <div>Text Link</div>
        <div className="px-2 py-3 border-2">Link Button</div>
        <div className="px-2 py-3 border-2 bg-red-500 text-white">
          Link Button
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">Styling Links</h1>
        <p>
      ...
      <div className="px-3 py-5 mt-10 bg-[#E7E9EB] rounded-md">
        <h1 className="text-2xl">Example</h1>
        <pre className="bg-white text-black font-mono text-sm whitespace-pre-wrap px-6 py-5 mt-3 rounded-md">
          {cssCode2}
        </pre>
