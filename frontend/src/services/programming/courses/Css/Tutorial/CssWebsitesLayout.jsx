    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Website Layout</h1>
      ...
      <div className="px-5 mt-5 py-10 rounded-md">
        <p className="pb-3">
          CSS is commonly used to build basic website structures. Most sites are
          divided into four main parts: Header, Navigation, Content and Footer.
        </p>
        <h1 className="text-2xl">Website Layout Structure</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li><strong>Header</strong>: Displays the logo, title, or top-level navigation.</li>
          <li><strong>Navigation Menu</strong>: Side or top menu to navigate different sections.</li>
          <li><strong>Main Content</strong>: The primary area where actual content appears.</li>
          <li><strong>Footer</strong>: Appears at the bottom for legal links, contact, etc.</li>
        </ul>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">CSS Website Layout Example</h1>
        <p>
          Below is a basic example of how to build a simple webpage layout using CSS.
        </p>
      </div>
...
export default CssWebsitesLayout;
