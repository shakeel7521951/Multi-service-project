    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Layout - display: inline-block</h1>
      ...
      <div className="px-5  mt-5 py-10 rounded-md">
        <h1 className="text-2xl mb-5">The display: inline-block Value</h1>
        <p>
          Compared to <span className="text-red-400">display: inline</span>, the
          major difference is that
          <span className="text-red-400"> display: inline-block</span> allows to
          set a width and height on the element.
        </p>
        <p className="py-5">
          Compared to <span className="text-red-400">display: block</span>, the
          major difference is that
          <span className="text-red-400"> display: inline-block</span> does not
          add a line-break after the element, so the element can sit next to
          other elements.
        </p>
        <p className="pb-5">
          The following example shows the different behavior of
          <span className="text-red-400"> display: inline</span>,
          <span className="text-red-400"> display: inline-block</span> and
          <span className="text-red-400"> display: block</span>:
        </p>
