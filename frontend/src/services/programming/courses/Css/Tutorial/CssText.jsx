    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Text</h1>
      ...
      <div className="px-5  mt-5 py-10 rounded-md">
        <p className="pb-3">CSS has a lot of properties for formatting text.</p>
        <div className="p-10 border m-5">
          <p className="text-center text-5xl text-uppercse my-5 text-green-300 "> TEXT FORMATTING</p>
