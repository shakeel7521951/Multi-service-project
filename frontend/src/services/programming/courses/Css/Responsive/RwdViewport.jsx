    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">Responsive Web Design - The Viewport</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <h1 className="text-2xl">What is The Viewport?</h1>
        <ul className="flex flex-col gap-3 my-5">
          ...
          <li>
            ...
            phones, fixed size web pages were too large to fit the viewport. To
            fix this, browsers on those devices scaled down the entire web page
            to fit the screen.
          </li>
          <li>This was not perfect!! But a quick fix.</li>
        </ul>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">Setting The Viewport</h1>
        <p>
          ...
          {`<meta>`} viewport element in the {`<head>`} section of all your web
          pages: .
        </p>
        <p className="py-3 px-2 border border-gray-300">
...
`}
        ...
        <p>{`The initial-scale=1.0 part sets the initial zoom level when the page is first loaded by the browser.

`}</p>
      </div>

      <div className="my-5">
        <h1>Size Content to The Viewport</h1>
        <div>
          <p>
            Users are used to scroll websites vertically on both desktop and
            mobile devices - but not horizontally!
          </p>
          <p>
            {" "}
            So, if the user is forced to scroll horizontally, or zoom out, to
            see the whole web page it results in a poor user experience.
          </p>
          <p className="my-5">Some additional rules to follow:</p>
        </div>
        <div>
          <p>
            1. Do NOT use large fixed-width elements - For example, if an image
            has a width wider than the viewport, it causes the viewport to
            scroll horizontally. Remember to adjust this content to fit within
            the width of the viewport.
          </p>
          <p>
            2. Do NOT let the content rely on a particular width to render well
            - Since screen dimensions and width in CSS pixels vary widely
            between devices, content should not rely on a particular viewport
            width to render well.
          </p>
          <p>3. Use CSS media queries to apply different styling for small and large screens - Setting large absolute CSS widths for page elements will cause the elements to be too wide for smaller devices. Instead, consider using relative width values, such as width: 100%. Also, be careful of using large absolute positioning values. It may cause the element to fall outside the viewport on small devices.</p>
        </div>
      </div>
