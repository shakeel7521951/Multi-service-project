    ...
    <div className="px-4">
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">Responsive Web Design - Videos</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <p className="pb-3">
          If the <code>width</code> property is set to <code>100%</code>, the video player will be responsive and scale up and down.
        </p>
        <p className="pb-3 font-semibold">Example:</p>
        ...
        <p className="pt-3">
          Note: In the example above, the video player can scale up to be larger than its original size.
          A better solution, in many cases, will be to use the <code>max-width</code> property instead.
        </p>
      </div>
