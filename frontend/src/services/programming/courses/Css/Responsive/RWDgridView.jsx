    ...
    <div className="px-4">
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">Responsive Web Design - Building a Grid View</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <p className="pb-3">
          Many web pages are based on a <strong>grid-view</strong>, which means that the page is divided into rows and columns.
        </p>
        <p className="pb-3">
          Using a grid-view helps with the design and layout of your page. It makes it easier to place elements.
        </p>
        <p className="pb-3">
          A responsive grid-view usually has 6 or 12 columns and adjusts to the screen size.
        </p>
        <p className="pb-3">
          First, set the <code>box-sizing</code> property on all elements to <code>border-box</code> to ensure padding and borders are included in the width and height:
        </p>
      </div>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">Starting Grid View CSS</h1>
        <p>Apply this CSS at the beginning of your style sheet:</p>
      </div>
