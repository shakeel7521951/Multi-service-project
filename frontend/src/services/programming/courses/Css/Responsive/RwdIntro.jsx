    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">Responsive Web Design - Introduction</h1>
      ...
      <div className="px-5  mt-5 py-10 rounded-md">
        <h1 className="text-2xl">What is Responsive Web Design?</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li>
            Responsive web design makes your web page look good on all devices.
          </li>
          <li>Responsive web design uses only HTML and CSS.</li>
          <li>Responsive web design is not a program or a JavaScript.</li>
        </ul>
