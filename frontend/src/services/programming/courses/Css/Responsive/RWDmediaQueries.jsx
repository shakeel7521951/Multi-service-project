...
const RWDmediaQueries = () => {
  ...
  const cssCode = `@media only screen and (max-width: 600px) {
  body {
    ...
    <div className="px-4">
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">Responsive Web Design - Media Queries</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        ...
        <p className="pb-3">
          For example, this media query changes the background color if the screen is 600px or smaller:
        </p>
      </div>
