    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Grid Columns, Rows and Gaps</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <h1 className="text-2xl">Grid Columns</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li>The vertical lines of grid items are called columns.</li>
        </ul>
        <h1 className="text-2xl">Grid Rows</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li>The horizontal lines of grid items are called rows.</li>
        </ul>
        <h1 className="text-2xl">Grid Gap</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li>The spaces between each column/row are called gaps.</li>
        </ul>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">The row-gap Property</h1>
        <p>
      ...
      <div className="px-3 py-5 bg-[#E7E9EB] rounded-md">
        ...
        <p>Specify a 50 pixels gap between the rows in the grid:</p>
