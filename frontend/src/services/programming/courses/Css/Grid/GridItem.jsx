    ...
    <div className="px-4">
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Grid Item</h1>
          <CiBookmark className="text-4xl text-green-400" />
        </div>
      </div>

      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <p className="pb-3">A grid container contains one or more grid items.</p>
        <p className="pb-3">By default, each grid item takes one cell. But with the <code>grid-column-start</code> and <code>grid-column-end</code> properties, you can control how many columns an item spans.</p>
        <p className="pb-3 font-semibold">Example: Make the first item span two columns</p>
      </div>
      ...
      <div className="px-3 py-5 bg-[#E7E9EB] rounded-md">
        ...
        <div className="pt-6">
          <h1 className="text-xl font-bold pb-2">Grid Layout with Spanning</h1>
          <div className="grid-container">
            <div className="item1">1 (spans 2 columns)</div>
            <div>2</div>
            <div>3</div>
            <div>4</div>
            <div>5</div>
