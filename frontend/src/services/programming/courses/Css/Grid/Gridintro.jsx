    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Grid Layout </h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <h1 className="text-2xl">CSS Grid</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li>
            The Grid Layout Module offers a grid-based layout system, with rows
            and columns.
          </li>
          <li>
            The Grid Layout Module allows developers to easily create complex
            web layouts.
          </li>
          <li>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">Grid Container and Grid Items</h1>
        <p>
          A grid layout consists of a parent element (the grid container), with
          one or more grid items.
        </p>
        <p>
