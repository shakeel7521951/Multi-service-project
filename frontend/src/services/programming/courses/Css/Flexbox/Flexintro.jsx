    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">Flexbox Introduction</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <h1 className="text-2xl">What is CSS Flexbox?</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li>Flexbox is short for the Flexible Box Layout module.</li>
          <li>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">A Flex Container with Three Flex Items</h1>
        <p>
        ...
        <div className="p-5 bg-blue-600 flex gap-10 ">
            <div className="px-4 py-3 bg-gray-200">1</div>
            <div className="px-4 py-3 bg-gray-200">2</div>
            <div className="px-4 py-3 bg-gray-200">3</div>
