    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">CSS Editor</h1>
      ...
      <div className="px-5 mt-5 py-10 rounded-md">
        ...
        <h1 className="text-2xl pb-3">Publish Your Code</h1>
        <p className="pb-2">
        ...
        <p className="pb-2">The code editor is packed with features to help you achieve more:</p>
        <ul className="list-disc list-inside mb-4">
          <li>Templates: Start from scratch or use a template</li>
          <li>Cloud-based: no installations required</li>
          <li>Terminal & Log: debug your code easily</li>
          <li>File Navigator: switch between files easily</li>
        </ul>
        <p className="pb-2">Practice is key! Use W3Schools Spaces to test and deploy CSS projects faster.</p>
      </div>

      {/* Example Section */}
      <div className="px-3 py-5 bg-[#E7E9EB] rounded-md mt-10">
        <h1 className="text-2xl">CSS Editor Example</h1>
        <p className="mt-3">This is a sample CSS code you can try and edit.</p>
