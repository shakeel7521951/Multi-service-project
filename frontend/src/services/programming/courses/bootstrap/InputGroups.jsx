  ...
  <div className="relative min-h-screen bg-gradient-to-br from-white via-[#f9f9f9] to-[#f0f0f0] px-0 sm:px-4 lg:px-6 py-3 sm:py-10 lg:py-14">
    <div className="max-w-6xl mx-auto space-y-5 sm:space-y-10 lg:space-y-14">
      ...
      <section className="bg-[#D9EEE1] p-5 sm:p-10 rounded-2xl shadow-lg border border-[#04AA6D]/30">
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-5 text-[#04AA6D]">Basic Input Group</h2>
      ...
      <section className="bg-white p-5 sm:p-10 rounded-2xl shadow-lg border border-gray-200">
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-5 text-[#04AA6D]">Input Group with Button</h2>
        <p className="text-gray-800 mb-4 leading-relaxed">
      ...
      {/* Multiple Addons */}
      <section className="bg-[#D9EEE1] p-5 sm:p-10 rounded-2xl shadow-lg border border-[#04AA6D]/30">
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-5 text-[#04AA6D]">Multiple Addons</h2>
        <p className="text-gray-800 mb-4 leading-relaxed">
      ...
      {/* Input Group Sizing */}
      <section className="bg-white p-5 sm:p-10 rounded-2xl shadow-lg border border-gray-200">
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-5 text-[#04AA6D]">Input Group Sizing</h2>
        <p className="text-gray-800 mb-4 leading-relaxed">
      ...
      <section className="bg-[#D9EEE1] p-5 sm:p-10 rounded-2xl shadow-lg border border-[#04AA6D]/30">
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-5 text-[#04AA6D]">Checkbox & Radio Input Groups</h2>
        <p className="text-gray-800 mb-4 leading-relaxed">
      ...
      <section className="bg-white p-5 sm:p-10 rounded-2xl shadow-lg border border-gray-200">
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-5 text-[#04AA6D]">Dropdowns in Input Groups</h2>
        <p className="text-gray-800 mb-4 leading-relaxed">
      ...
      <section className="bg-[#D9EEE1] p-5 sm:p-10 rounded-2xl shadow-lg border border-[#04AA6D]/30">
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-5 text-[#04AA6D]">Validation Input Groups</h2>
        <p className="text-gray-800 mb-4 leading-relaxed">
