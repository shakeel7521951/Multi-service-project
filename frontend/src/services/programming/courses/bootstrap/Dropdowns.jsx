      ...
      <div className="max-w-6xl mx-auto space-y-5 sm:space-y-10 lg:space-y-14">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Dropdowns in Bootstrap allow users to toggle contextual overlays for
            displaying lists of links and actions. They can include headers,
            dividers, forms, and can open in multiple directions.
          </p>
        </div>
        ...
        <section className="bg-[#D9EEE1] p-5 sm:p-10 rounded-2xl shadow-lg border border-[#04AA6D]/30">
          ...
          <p className="text-gray-800 mb-4 leading-relaxed">
            A simple dropdown with a button and a list of links. Click to toggle
            visibility.
          </p>
        ...
        <section className="bg-white p-5 sm:p-10 rounded-2xl shadow-lg border border-gray-200">
          ...
          <p className="text-gray-800 mb-4 leading-relaxed">
            Split buttons allow separating the main action from the dropdown
            toggle.
          </p>
        ...
        <section className="bg-[#D9EEE1] p-5 sm:p-10 rounded-2xl shadow-lg border border-[#04AA6D]/30">
          ...
          <p className="text-gray-800 mb-4 leading-relaxed">
            Add headers, separators, and organize dropdown content for better
            UX.
          </p>
        ...
        <section className="bg-white p-5 sm:p-10 rounded-2xl shadow-lg border border-gray-200">
          ...
          <p className="text-gray-800 mb-4 leading-relaxed">
            Dropdown buttons can have different sizes using <code>.btn-lg</code>{" "}
            or <code>.btn-sm</code>.
          </p>
        ...
        <section className="bg-[#D9EEE1] p-5 sm:p-10 rounded-2xl shadow-lg border border-[#04AA6D]/30">
          ...
          <p className="text-gray-800 mb-4 leading-relaxed">
            Dropdowns can open in different directions: <code>dropup</code>,{" "}
            <code>dropend</code>, and <code>dropstart</code>.
          </p>
