      ...
      <div className="max-w-6xl mx-auto space-y-5 sm:space-y-10 lg:space-y-14">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-700 text-lg max-w-3xl mx-auto leading-relaxed">
            Alerts are used to provide feedback messages to users. Bootstrap
            alerts support contextual colors, links, dismissible options, and
        ...
        <section className="bg-[#D9EEE1] p-5 sm:p-10 rounded-2xl shadow-lg border border-[#04AA6D]/30">
          ...
          <p className="text-gray-800 mb-4 leading-relaxed">
            Use <code>.alert</code> with contextual classes to display simple
            alerts.
          </p>
