  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-white via-[#f9f9f9] to-[#f0f0f0] px-0 sm:px-4 lg:px-6 py-3 sm:py-10 lg:py-14">
      <div className="w-full max-w-6xl mx-auto space-y-5 sm:space-y-14">
        ...
        {/* What is Bootstrap */}
        <section className="bg-[#D9EEE1] p-5 sm:p-8 lg:p-10 rounded-2xl shadow-lg border border-[#04AA6D]/30">
          <h2 className="text-xl sm:text-3xl font-bold mb-4 text-[#04AA6D]">
            What is Bootstrap?
          </h2>
          <p className="text-gray-800 mb-3 leading-relaxed text-sm sm:text-base md:text-lg">
          ...
          <ul className="list-disc list-inside text-gray-800 space-y-2 mb-4 text-sm sm:text-base">
        ...
        {/* Why use Bootstrap */}
        <section className="bg-white p-5 sm:p-8 lg:p-10 rounded-2xl shadow-lg border border-gray-200">
          <h2 className="text-xl sm:text-3xl font-bold mb-4 text-[#04AA6D]">
            Why Use Bootstrap?
          </h2>
          <p className="text-gray-800 mb-4 leading-relaxed text-sm sm:text-base md:text-lg">
        ...
        <section>
          ...
          <p className="text-gray-700 mb-4 text-xs sm:text-sm md:text-base">
