    ...
    <div className="px-4">
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">Upgrade React</h1>
        ...
        <div className="flex justify-between">
          ...
          >
            <MdKeyboardArrowLeft className="text-3xl" /> Home
          </Link>
        </div>
      </div>

      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <h1 className="text-2xl font-semibold mb-4">Upgrade to React 18</h1>
        <p className="mb-3">
          Upgrading an existing React application to version 18 only requires two
          steps.
        </p>
        <p className="mb-3">
          If you are already using the latest version of create-react-app which uses
          React version 18 you can skip this section.
        </p>
        <h2 className="text-xl font-semibold mt-4 mb-2">Step 1: Install React 18</h2>
        <p className="mb-3">
          To install the latest version, from your project folder run the following
          from the terminal:
        </p>
        <pre className="bg-white p-3 rounded-md text-black font-mono text-sm">
          npm i react@latest react-dom@latest
        </pre>

        <h2 className="text-xl font-semibold mt-4 mb-2">Step 2: Use the new root API</h2>
        <p className="mb-3">
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">React Upgrade Example</h1>
        <p>Here is how you update your root API from React 17 to React 18:</p>
      </div>

      <div className="px-3 py-5 bg-[#E7E9EB] rounded-md">
        <h1 className="text-2xl">React Upgrade Code</h1>
      ...
      <div className="px-1 my-10">
        ...
        <p className="max-w-3xl pb-5">
          Explore all the core topics of React including hooks, props, state, JSX,
          and more through the references below.
        </p>
        ...
        <div className="flex justify-between">
          ...
          >
            Next <MdOutlineKeyboardArrowRight className="text-3xl" />
          </Link>
        </div>
      </div>
    </div>
