    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">React Props</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        ...
        <h1 className="text-2xl">What are Props?</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li>Props are read-only and help pass data from parent to child.</li>
          <li>Props are similar to function arguments.</li>
          <li>
            You can pass any type of data (string, number, object, function) as props.
          </li>
          <li>
            Inside a component, props are accessed via the <code>props</code> object.
          </li>
        </ul>
        <div className="flex px-5 w-fit cursor-pointer py-2 text-xl font-semibold rounded-lg text-white bg-[#03945F] items-center">
          Start Learning Props Now
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">React Props Example</h1>
        <p>This example demonstrates how to pass props into a component:</p>
      </div>
      ...
      <div className="px-1 my-10">
        ...
        <p className="max-w-3xl pb-5">
          Here are the main concepts in React you should be familiar with to master props and component behavior.
        </p>
