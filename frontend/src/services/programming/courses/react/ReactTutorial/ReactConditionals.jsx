    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">React Conditional Rendering</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <p className="pb-3">
          In React, you can conditionally render different components based on logical conditions.
        </p>
        <h1 className="text-2xl">How to Conditionally Render</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li>You can use JavaScript’s <code>if</code> statement to choose which component to show.</li>
          <li>Conditional rendering allows for dynamic UIs based on props or state.</li>
          <li>This helps in showing/hiding UI blocks or components as needed.</li>
        </ul>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">React Conditional Rendering Example</h1>
        <p>This example demonstrates using <code>if</code> statements to render components based on a condition:</p>
      </div>
      ...
      <div className="px-1 my-10">
        ...
        <p className="max-w-3xl pb-5">
          Here are important React topics to strengthen your understanding of conditional rendering.
        </p>
