    ...
    <div className="px-4">
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">React ES6</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <p className="pb-3">ES6 stands for ECMAScript 6.</p>
        <p className="pb-3">
        ...
        <h2 className="text-2xl font-semibold py-3">Why Should I Learn ES6?</h2>
        <p className="pb-3">
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">React ES6 Examples</h1>
        <p>Here are some examples of ES6 syntax commonly used in React:</p>
      </div>

      <div className="px-3 py-5 bg-[#E7E9EB] rounded-md">
        <h1 className="text-2xl">ES6 Code Example</h1>
      ...
      <div className="px-1 my-10">
        ...
        <p className="max-w-3xl pb-5">
          At W3Schools you will find complete CSS references of all properties and selectors
          with syntax, examples, browser support, and more.
        </p>
