    ...
    <div className="px-4">
      ...
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">React Forms</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <p className="pb-3">
          Just like in HTML, React uses forms to allow users to interact with the page.
        </p>
        <h1 className="text-2xl">Adding Forms in React</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li>You can create forms using standard HTML form tags.</li>
          <li>React can handle input fields and form submissions using state and event handling.</li>
        </ul>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">React Form Example</h1>
        <p>This example creates a basic form with a text input for the user's name.</p>
      </div>
      ...
      <div className="px-1 my-10">
        ...
        <p className="max-w-3xl pb-5">
          These references are useful to continue learning about form handling and other important topics in React.
        </p>
