    ...
    <div className="px-4">
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">React Render HTML</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <p className="pb-3">
          React's goal is in many ways to render HTML in a web page. It uses the
          <code> createRoot() </code> function and its <code> render() </code> method to
          accomplish this.
        </p>
        <p className="pb-3">
          <strong>createRoot Function:</strong> It takes one argument – an HTML element – and defines where your component will be rendered.
        </p>
        <p className="pb-3">
          <strong>render Method:</strong> Called on the root to render your component.
        </p>
        <p className="pb-3">
          In a React project, you'll find a <code>public/index.html</code> file that has a
          <code> &lt;div id="root"&gt; </code>. React mounts your app into this div.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">React Render Example</h1>
        <p>This code shows how to render a simple paragraph into the root element:</p>
      </div>
