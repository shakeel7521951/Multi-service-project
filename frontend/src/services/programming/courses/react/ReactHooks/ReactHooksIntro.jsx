  ...
  return (
    <div className="px-4">
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <p className="pb-3">
          Hooks were added to React in version 16.8. They allow functional components to access state and other React features.
        </p>
        <h1 className="text-2xl">What is a Hook?</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li>Hooks let you "hook into" React state and lifecycle features from function components.</li>
          <li>They replace the need for class components in most cases.</li>
          <li>Examples of hooks: <code>useState</code>, <code>useEffect</code>, <code>useContext</code>, etc.</li>
        </ul>
        <div className="flex px-5 w-fit cursor-pointer py-2 text-xl font-semibold rounded-lg text-white bg-[#03945F] items-center">
          Start Learning Hooks Now
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">React useState Hook Example</h1>
        <p>This example demonstrates how to use the useState Hook to manage state in a functional component.</p>
      </div>
      ...
      <div className="px-1 my-10">
        ...
        <p className="max-w-3xl pb-5">
          Here's a list of important React topics to explore beyond hooks:
        </p>
