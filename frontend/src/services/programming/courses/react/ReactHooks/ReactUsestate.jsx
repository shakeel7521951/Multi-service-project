    ...
    <div className="px-4">
      <div className="mt-10">
        <div className="flex justify-between mb-5">
          <h1 className="text-4xl">React useState Hook</h1>
      ...
      <div className="px-5 bg-[#D9EEE1] mt-5 py-10 rounded-md">
        <p className="pb-3">
          The <code>useState</code> Hook allows you to add state to function components in React.
        </p>
        <h1 className="text-2xl">How useState Works</h1>
        <ul className="flex flex-col gap-3 my-5">
          <li>Import it from React using <code>import &#123; useState &#125; from 'react'</code>.</li>
          <li>Call <code>useState</code> inside your function component to create a state variable.</li>
          <li><code>useState</code> returns a state value and a function to update it.</li>
        </ul>
        <div className="flex px-5 w-fit cursor-pointer py-2 text-xl font-semibold rounded-lg text-white bg-[#03945F] items-center">
          Start Learning useState Now
      ...
      <div className="flex flex-col gap-4 mb-6">
        <h1 className="text-4xl">React useState Example</h1>
        <p>This example tracks the user's favorite color and updates the state on input change:</p>
      </div>
      ...
      <div className="px-1 my-10">
        ...
        <p className="max-w-3xl pb-5">
          Mastering <code>useState</code> will help you understand the core of stateful React applications.
        </p>
